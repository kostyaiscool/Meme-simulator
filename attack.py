...
class ProjectileAttack():
    def __init__(self, damage, x, y, scale, direction, image, speed, returnable):
        self.damage = damage
        self.image = image
        self.x = x
        self.y = y
    ...
    def operate_attack(self, player, boss):
        if self.rect != None:
            ...
            if self.rect.colliderect(player.rect):
                ...
                print(player.hp)
                self.rect = None
            elif self.rect.colliderect(boss.rect) and self.returnable:
                boss.hp -= self.damage
                print(boss.hp)
                self.rect = None
...
def spawn_projectile(dmg, x, y, scale, direction, image, speed, returnable: bool):
    attacks.append(ProjectileAttack(dmg, x, y, scale, direction, image, speed, returnable))
